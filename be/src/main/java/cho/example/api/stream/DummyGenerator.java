...
public class DummyGenerator  {
    ...
    public String makeEmail() {
        ...
        shuffle(ls); //substring
        return makeUsername()+ls.get(0);
    }
    ...
    private String mycalendar(int start, int end) {
        ...
        int year = rangeRandom.apply(start, end);

        switch (month){
            case 4: case 6 : case 9: case 11: date = date30; break;
            case 2: date = ((year % 4 == 0 && year % 100 != 0) || year % 400 == 0) ? date29 :date28; break;
            default: date =date31;
        }
